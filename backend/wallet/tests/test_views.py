...
def test_transaction_view_no_filters():
    ...
    transaction_1 = Transaction.objects.create(sender=sender_wallet, receiver=receiver_wallet, amount=20, created_at=timezone.now())
    transaction_2 = Transaction.objects.create(sender=sender_wallet, receiver=receiver_wallet, amount=40, created_at=timezone.now() - timedelta(days=1))
